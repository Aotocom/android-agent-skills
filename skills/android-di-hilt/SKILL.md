...
metadata:
  ...
  triggers:
    include: ["android hilt setup", "inject viewmodel repository hilt", "scope dependency in android", "replace manual service locator", "hilt testing override"]
    exclude: ["retrofit serialization only", "compose typography only", "gradle wrapper upgrade"]
